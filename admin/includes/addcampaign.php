		...
		$sql = "INSERT INTO `tblCampaign` 
		                  ...
		                  VALUES 
		                        ('" . addslashes(trim($_POST['title'])) . "', 
		                         ...
		                         '" . $_POST['emailstatus'] . "', 
		                         '" . addslashes(trim($subjectextern)) . "', 
		                         '" . addslashes(trim($messageextern)) . "', 
		                         '" . addslashes(trim($_POST['subjectintern'])) . "', 
		                         '" . addslashes(trim($_POST['messageintern'])) . "', 
		                         '" . trim($_POST['messageinterntype']) . "',
		                         '" . (int) $_POST['messageinterntype_id'] . "',
		                         '" . (int) $_POST['sendid'] . "', 
...
<table style="vertical-align:top" align="center" width="95%" height="95%" cellpadding="0" cellspacing="0" border="0">	
	...
	<!-- Page title line -->
	<tr>
			<td width="100%"><font class="pagetitle">Create Campaign </font></td>
	</tr>
	<!-- Page content line -->
	<tr>
		<td height="10"></td>
		...
		<td valign="top">
			...
			<tr>
				...
				<tr>
					...
					<select class="tabletext" name="sendid" id="sendid">
			...
			<tr>
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="25%" align="right">&nbsp;&nbsp;<font class="tabletext">Campaign Routed:</font></td>
					<td width="75%" align="left">&nbsp;<font class="tabletext">
					<? $query_servers = mysql_query("SELECT `id`,`servername`, `domain` FROM `tblServers` ORDER BY `domainip` ASC");?>
			...
			<tr>
				...
				<tr>
					...
					<? }?>
					</select> (hold CTRL for multiple select)</font></td>
				</tr>
				</table>				
				</td>
			</tr>
			...
			<tr>
				<td bgcolor="#FFFFE6" width="100%" style="padding:10px"><font class="tabletext" style="font-weight:bold"><font color="#990000">Note!</font> You can use: [%to_name%], [%from_name%], [%to_location%], [%from_location%], [%to_imagelink%], [%from_imagelink%], [%to_videolink%], [%from_videolink%],<br/> [%hidden_image%], [%login_link%], [%unsubscribe_link%] and [%to_password%].</font></td>
			</tr>
			<tr>
				...
				<tr style="padding-top: 30px;">
					...
					<td width="75%" align="left">&nbsp;<font class="tabletext"><input maxlength="100" type="text" class="tabletext" name="subjectintern" id="subjectint" style="width: 95%" <?if(isset($_POST['subjectintern']) AND trim($_POST['subjectintern']) != ''){ echo "value=\"" . $_POST['subjectintern'] . "\""; } else { echo "value=\"\"";}?> /></font></td>
				</tr>
				</table>		
				</td>
			</tr>
			<tr>
				...
				<tr>
					...
					<td width="75%" align="left">&nbsp;<font class="tabletext"><textarea class="tabletext" name="messageintern" id="messageint" style="width: 95%; height: 400px;"><?if(isset($_POST['messageintern']) AND trim($_POST['messageintern']) != ''){ echo $_POST['messageintern']; }?></textarea></font></td>
				</tr>
				</table>				
				</td>
			</tr>
				...
				<tr>
					...
					<td width="75%" align="left" style="padding-left: 10px;">
					  <table cellpadding="0" cellspacing="0">
					    <tr>
					      <td class="tabletext">
					  		<div id="messageinterntype" style="display: inline;">No attachments</div>
					  	  </td>
					  	  <td>
	...
	<tr>
		<td valign="top">
			...
			<tr>
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td align="center" width="100%">&nbsp;&nbsp;<font class="tablecateg"><input class="tablecateg" type="button" onclick="javascript: verif('addform','<?=$verif ?>')" style="color:#333333; width: 200px; height: 35px;" name="insert" value="Insert Campaign">&nbsp;&nbsp;<input class="tablecateg" type="reset" style="color:#333333; width: 200px; height: 35px;" name="reset" value="Reset Campaign"></font></td>
				</tr>
				</table>				</td>
			</tr>
			</table>		</td>
