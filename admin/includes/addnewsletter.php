		...
		$sql = "INSERT INTO `tblNewsletter` 
		                  ...
		                  VALUES 
		                        ('" . addslashes(trim($_POST['title'])) . "', 
		                         ...
		                         '" . $_POST['howmany'] . "', 
		                         '" . $_POST['interval'] . "', 
		                         '" . addslashes(trim($_POST['subject'])) . "', 
		                         '" . addslashes(trim($_POST['message'])) . "', 
		                         '" . addslashes($_POST['sendemail']) . "', 
		                         '" . addslashes($_POST['sendname']) . "', 
...
?>
<form name="addform" method="post" action="index.php?content=addnewsletter">
...
<table style="vertical-align:top" align="center" width="95%" height="95%" cellpadding="0" cellspacing="0" border="0">	
	...
	<!-- Page title line -->
	<tr>
			<td width="100%"><font class="pagetitle">Create Newsletter </font></td>
	</tr>
	<!-- Page content line -->
	<tr>
		<td height="10"></td>
	...
	<tr>
		<td valign="top">
			...
			<tr>
				<td bgcolor="#FFFFE6" width="100%" style="padding:10px"><font class="tabletext" style="font-weight:bold"><font color="#990000">Note!</font> You can use: [%to_name%], [%to_location%], [%to_imagelink%], [%to_videolink%], [%hidden_image%], [%login_link%] and [%to_password%].</font></td>
			</tr>
			<tr>
				...
				<tr style="padding-top: 30px;">
					...
					<td width="75%" align="left">&nbsp;<font class="tabletext"><input maxlength="100" type="text" class="tabletext" name="subject" id="subject" style="width: 95%" value="" /></font></td>
				</tr>
				</table>		
				</td>
			</tr>
			<tr>
				...
				<tr>
					...
					<td width="75%" align="left">&nbsp;<font class="tabletext"><textarea class="tabletext" name="message" id="message" style="width: 95%; height: 400px;"></textarea></font></td>
				</tr>
				</table>				
				</td>
			</tr>
			<tr>
				...
				<tr>
					...
					<td width="75%" align="left">&nbsp;<font class="tabletext"><input maxlength="15" type="text" class="tabletext" name="toscreenname" id="testscreen" size="35" value="" /></font></td>
				</tr>
				</table>		
				</td>
			</tr>
	...
	<tr>
		<td valign="top">
			...
			<tr>
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td align="center" width="100%">&nbsp;&nbsp;<font class="tablecateg"><input class="tablecateg" type="button" onclick="javascript: verif('addform','<?=$verif ?>')" style="color:#333333; width: 200px; height: 35px;" name="insert" value="Insert Newsletter">&nbsp;&nbsp;<input class="tablecateg" type="reset" style="color:#333333; width: 200px; height: 35px;" name="reset" value="Reset Newsletter"></font></td>
				</tr>
				</table>				</td>
			</tr>
			</table>		</td>
