 ...
 *
 * @version $Id: _goal.class.php,v 1.11 2011/09/07 22:44:41 fplanque Exp $
 */
...
class Goal extends DataObject
{
	...
	function Goal( $db_row = NULL )
	{
  	...
  	$this->delete_cascades = array(
 		...
 		if( $db_row )
		{
			...
			// Receive property value from database
			$this->greetings     = $db_row->goal_greetings;
		}
		else
		{	// Create a new goal:
		}
	...
	function load_from_Request()
	{
		...
		// Validate greetings property
		// Greetings
		$this->set_string_from_param( 'greetings', true );
	...
	function set( $parname, $parvalue, $make_null = false )
	{
		switch( $parname )
		{
			...
			case 'name':
			case 'key':
			// Set to NULL if greetings has empty value
			case 'greetings':
			default:
