 ...
 *
 * @version $Id: _goal.form.php,v 1.13 2011/09/07 22:44:40 fplanque Exp $
 */
...
$Form->begin_form( 'fform', $creating ?  T_('New goal') : T_('Goal') );
	...
	// Make input field for greetings
	$Form->text_input( 'goal_greetings', $edited_Goal->greetings, 25, T_('Greetings'), '' , array( 'maxlength'=> 30 ) );
