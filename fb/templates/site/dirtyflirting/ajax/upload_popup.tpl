{* $Id: upload_popup.tpl 529 2008-06-12 20:29:41Z andi $ *}
...
<div class="clearfix" style="width:600px">
	...
	<div style="float:right;">
		<a href="javascript:;" onclick="$('#upload_popup').jqmHide().remove()" title="Close">
...
function uploadDone() {
	try {
		...
		$('#upload_form').ajaxSubmit({
			url: '{/literal}{$cfg.path.url_site}ajax_upload_popup.php?e={$smarty.get.e}&u=t{literal}',
			success: function() {},
			dataType: "script"
		});
	} catch (ex) {
