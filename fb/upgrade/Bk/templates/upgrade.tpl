	...
	<tr>
		...
		{* MEMBER PAGE - RIGHT - *}
																	 ...
																	 <tr>
																		 ...
																		 <td style="padding-top: 5px; padding-left: 10px;">
																			 ...
																			 {else}
																				 ...
																				 <img class="preview" src="https://www.flirtigo.com/showphoto.php?id={$user.id}&m=Y&t=r&p=1" />
									 ...
									 <table cellpadding="0" cellspacing="0" border="0" style="width: 285px;">
										 ...
										 <tr style="padding-top: 5px; padding-left: 10px;">
											 ...
											 <td class="normaltext screenname">
											 	...
											 	<img src="https://www.flirtigo.com/templates/site/dirtyflirting/login/images/dirtyflirting_mailpicture.gif" alt="FlirtiGo.com" />

											 	{/if}

											 	{if $user.withvideo eq 'Y'}

											 	<img src="https://www.flirtigo.com/templates/site/dirtyflirting/login/images/dirtyflirting_mailvideo.gif" alt="FlirtiGo.com" />
			...
			{/if}
														 ...
														 <tr>
															 ...
															 <td width="735" align="center" valign="top">
																 ...
																 <img border="0" src="https://www.flirtigo.com/upgrade/images/upgradeoptions.jpg" style="border-color: #FFFFFF;"/>
			...
			<tr>
					...
					<input name="acctype" type="radio" value="2" checked>3 Months Special Offer Upgrade just {$pricetwo} (thats 1 Month FREE)!
			...
			<tr>
					...
					<input name="acctype" type="radio" value="1">1 Month Upgrade just {$priceone}
			...
			<tr>
															 ...
															 <option value="no" selected>Choose Payment Type</option>
																		 <option value="ccbillcc">Pay with my Credit/Debit Card</option>

																		 {if $countryName=='United States'}

																		 <option value="ccbillck">Using my Checking Account</option>

						 {/if}

						 {if $countryName=='Canada'}

																		 <option value="charge">Using my Checking Account</option>
						 ...
						 {/if}
													 ...
													 <tr>
														 ...
														 <td colspan="2" align="center" height="10">
																 ...
																 <input type="submit" name="submit" value="Upgrade Now!"><br>
														 ...
														 <td colspan="2" align="center" height="90" class="footer">
