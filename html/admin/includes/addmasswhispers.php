<?
	if(!empty($_POST["action"]) && $_POST["action"]=="add")
	{
		...
		$sql = "INSERT INTO `tblMassWhispers` 
		                        (`title`, 
		                         `description`, 
		                         `age_from`,
		                         `age_to`,
		...
		if(($emailserver > 0 AND $looking > 0) OR trim($_POST['toscreenname']))
		{
			...
			if(mysql_affected_rows() > 0){
				$msg = "MassWhispers SUCCESFULLY INSERT";
				echo "<script language='javascript'>window.location = 'index.php?content=masswhispers'</script>";
				exit;
			} else {
				$msg = "<font color='red'> ERROR: MassWhispers WAS NOT INSERT!! Unknown Error!! <br> " . mysql_error() . "</font>";
			}
		} else {
			$msg = "<font color='red'> ERROR: MassWhispers WAS NOT INSERT!! <br> Select 'Looking For' AND 'Email Server'!</font>";
		}
	} else {
		$msg = '';
	}
?>
<form name="addform" method="post" action="index.php?content=addmasswhispers">
...
<table style="vertical-align:top" align="center" width="95%" height="95%" cellpadding="0" cellspacing="0" border="0">	
	...
	<!-- Page title line -->
	<tr>
			<td width="100%"><font class="pagetitle">Create MassWhispers Campaign </font></td>
	</tr>
	<!-- Page content line -->
	<tr>
		<td height="10"></td>
	...
	<tr>
		<td valign="top">
			...
			<tr>
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="25%" align="right">&nbsp;&nbsp;<font class="tabletext">How many whispers:</font></td>
			...
			<tr>
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="25%" align="right">&nbsp;&nbsp;<font class="tabletext">Whisper:</font></td>
					<td width="75%" align="left">&nbsp;<font class="tabletext">
					<select name="whisperid" style="width: 350px;">
					<?
						$q="select * from `tblWhispers` order by `id`";
						$q=mysql_query($q);
						$nrq=mysql_num_rows($q);
						for($j=0;$j<$nrq;$j++){
							$whisper=mysql_fetch_array($q);
							echo "<option value='".$whisper["id"]."'>".$whisper["whisper"]."</option>";
						}
					?>
					</select>
					</font></td>
	...
	<tr>
		<td valign="top">
			...
			<tr>
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td align="center" width="100%">&nbsp;&nbsp;<font class="tablecateg"><input class="tablecateg" type="button" onclick="javascript: verif('addform','<?=$verif ?>')" style="color:#333333; width: 200px; height: 35px;" name="insert" value="Insert">&nbsp;&nbsp;<input class="tablecateg" type="reset" style="color:#333333; width: 200px; height: 35px;" name="reset" value="Reset"></font></td>
				</tr>
				</table>				</td>
			</tr>
			</table>		</td>
