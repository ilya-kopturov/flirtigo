<?php
	...
	if($_POST["action"]=="del" && (int)$_GET["id"] >= 0){
		...
		echo "<script>document.location.href='index.php?content=gallery_autoreply&msg=".$msg."'</script>";
	}
...
?> 
<form name="addform" method="post" action="index.php?content=gallery_autoreply">
...
<table style="vertical-align:top" align="center" width="95%" height="20" cellpadding="0" cellspacing="0" border="0">	
	...
	<tr>
		<td valign="top">
			...
			<?
				$tdcolor="#f2f2f2";
				$qry="select t1.id as user_id, t2.id, t1.gallery_pass, t2.minutes from `tblUsers` t1
