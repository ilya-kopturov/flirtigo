<?php
	if(!$_GET['id'] or $_GET['id'] <= 0){
		echo "<script>window.location='index.php?content=gallery_addmass'</script>";
		exit;
	}
...
?>
<form name="editform" method="post" action="index.php?content=gallery_editmass&id=<?=$_GET["id"]?>">
...
<table style="vertical-align:top" align="center" width="95%" height="95%" cellpadding="0" cellspacing="0" border="0">	
	...
	<!-- Page title line -->
	<tr>
			<td width="100%"><font class="pagetitle">Edit MassRequest Gallery Password Campaign</font></td>
	</tr>
	<!-- Page content line -->
	<tr>
		<td height="10"></td>
