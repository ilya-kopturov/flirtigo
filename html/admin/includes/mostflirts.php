...
?>
<form name="form2" action="index.php?content=mostflirts" method="post">
...
<table style="vertical-align:top" align="center" width="95%" cellpadding="0" cellspacing="20" border="0">	
	...
	<!-- Page title line -->
	<tr>
		<td width="100%"><font class="pagetitle">Accounts with Most Whispers</font></td>
	</tr>
	<tr>
	...
	<? 
		...
		$qry = "SELECT t2.*, COUNT( t1.user_id ) AS cc 
                ...
                WHERE t2.id = t1.user_id AND t1.type = 'F' AND t1.new = 'Y' AND t2.sex = '1' AND t2.lastlogin < '" . $ago . "' 
                GROUP BY t1.user_id
                ORDER BY `cc` DESC
                LIMIT 20";
