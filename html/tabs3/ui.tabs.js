 ...
 *	ui.core.js
 *
 * Revision: $Id: ui.tabs.js 547 2008-06-14 15:05:02Z andi $
 */
;(function($) {
	...
	$.widget("ui.tabs", {
		...
		tabify: function(init) {
			...
			//dhtmlHistory.add($('a', this.$lis[o.selected]).attr('href').substr(1), {tabs:this.element.parent().attr('id'), select:o.selected});
			...
			function showTab(clicked, $show, $hide) {
				window.location.hash = clicked.hash;
				if (showFx === baseFx)
			...
			function switchTab(clicked, $li, $hide, $show) {
				...
				var $toShow = $(clicked.hash), toShowId = $toShow.attr('id');
				$toShow.attr('id', '');
				//dhtmlHistory.add(clicked.hash.substr(1), {tabs:$(self.element).parent().attr('id'), select:clicked.hash.substr(1)});
				setTimeout(function() {
					$toShow.attr('id', toShowId); // restore id
				}, 500);
			}
