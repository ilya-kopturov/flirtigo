...
$paged_data = Pager_Wrapper_MDB2($db, $sql_search . " ORDER BY u.withpicture DESC, u.accesslevel DESC", $pagerOptions);
//print_r($paged_data);
...
$smarty->display("{$cfg['template']['dir_template']}login/browseresults.tpl" );
