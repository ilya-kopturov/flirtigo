...
<table style="vertical-align:top" align="center" height="20" cellpadding="0" cellspacing="0" border="0">
	...
	<!-- Page title line -->
	<tr>
		<td><font class="pagetitle">Settings</font></td>
	</tr>
	<!-- Page content line -->
	<tr>
		<td height="10"></td>
	...
	<tr>
		<td valign="top">
			...
			<tr bgcolor="#FFFFFF">
				<td width="200">
					&nbsp;<font class="tabletext">Days before email becomes urgent and requiring reply:</font>
				</td>
				<td width="250">
					<input type="hidden" name="key" value="chat_days_for_urgent_mail" />
					<input type="text" name="value" style="width: 250px;" value="<?=  htmlentities($settings['chat_days_for_urgent_mail']) ?>" />
				</td>
				<td width="70">
