...
<div style="text-align:left;">
	...
	<div style="font-size:11px;text-align:left;">
		...
		<ol>
			<li>Only video of yourself and your partner (if applicable) are allowed.</li>
			<li>If you upload sexually explicit content you agree to comply with <a href="javascript:;" onclick="$('#profile_videos').load('{$cfg.path.url_site}2257.php?tabname=video&{rnd_md5}');">the additonal terms stated here</a></li>
			<li>No video of animals, anyone appearing under 18 or other items other than the person(s) featured in the profile. No images of acts such as torture or pain.</li>
			<li>No contact details to be included in any video.</li>
			<li>Don't upload single images bigger than 20MB</li>
		</ol>
	</div>
</div>
