   ...
   <table class="center header">
     <tr>
       ...
       <td style="vertical-align: bottom; text-align: right;" class="logout">
         [ <i>{$smarty.session.sess_screenname}</i> | <a href="{$logout_url}" class="logout">Logout</a> ] <img src="{$cfg.template.url_template_ssl}login/images/hornybook_loginitem.jpg" border="0" alt="FlirtiGo.com" align="absmiddle" />
       </td>
     </tr>
   </table>
