...
<div class="tabs_content">
	...
	<div class="pic_no_user"><img src="{$cfg.template.url_template}login/images/hornybook_bgpicture_full.gif" alt="" style="width: 94px; height: 94px; border: 1px;" /></div>
	{/if} 
...
<div class="pic_no_user"><img src="{$cfg.template.url_template}login/images/hornybook_bgpicture_full.gif" alt="" style="width: 94px; height: 94px; border: 0px;" /></div>
{/if}
...
<div class="thumb"><img
	...
	src="/showphoto.php?id={$smarty.session.sess_id}&m=Y&t=s&p=1" alt=""
	class="photo" /></div>
