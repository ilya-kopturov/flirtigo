...
<div class="center">
    ...
    <div class="index_container">
        <div id="featured_block" class="grey">
            ...
            <div class="tabs_header">
                <div id="viewcontent">
                    <ul>
                        <li><a href="#Picture_Gallery" title="Picture Gallery">	Picture Gallery </a></li>
                        <li><a	href="#Video_Gallery{if $smarty.session.sess_accesslevel == 0}_Upgrade{/if}"
            ...
            <div class="tabs_content">
                ...
                <div id="Video_Gallery"	style="display: none; padding: 0px; margin: 0px; border: 0px;">
                    ...
                    <div class="pic_no_user">
                        <!--<img src="{$cfg.template.url_template}login/images/hornybook_bgpicture_full.gif" alt="" style="width: 94px; height: 94px; border: 1px;" />-->
                        <div class="div_pic_no_user"></div>
                    </div>
                    {/if} 
                ...
                <div id="Picture_Gallery" style="display: none; padding: 0px; margin: 0px; border: 0px;">
                    {section name="picture" loop=$picturegallery max=8}
                    ...
                    <div class="pic_no_user">
                        <!--<img src="{$cfg.template.url_template}login/images/hornybook_bgpicture_full.gif" alt="" style="width: 94px; height: 94px; border: 0px;" />-->
                        <div class="div_pic_no_user"></div>
                    </div>
                    {/if}
        ...
        <div id="inbox_snapshot_block" class="grey">
            ...
            <div id="tab_header_inbox">
                <div class="ui-tabs-nav" style="margin: 0; padding: 0;">
                    <span class="ui-tabs-selected">
                        <a href="#">Inbox</a>
                    </span>
                </div>
            </div>
    ...
    <div class="index_container">
        <div class="grey" id="my_hb_block">
            <div class="container_text caption"><span
                    class="container_red_text">My</span> Lists</div>
            ...
            <div class="tabs_content">
                ...
                <div id="Viewed_Me"
                    ...
                    {else}
                    <div class="pic_no_user">
                        <!--<img src="{$cfg.template.url_template}login/images/hornybook_bgpicture_full.gif" alt="" />-->
                        <div class="div_pic_no_user"></div>
                    </div>
                    {/if} {/section}</div>
                <div id="Hot_List"
