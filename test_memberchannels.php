...
//die();
	...
	if (session_is_registered("sess_screenname") == FALSE || session_is_registered("sess_pass") == FALSE) {
...
<html>
<link href="memberchannels_6.css" media="screen" rel="stylesheet" type="text/css" >
<body>
			<table border=0 width=70% align=center>
				<tr>
					<td>
					<!-- start Member Channels Feeds-->
					...
					var MC_upgrade_url = '<?php echo$cfg[path][url_site]?>upgrade/index.php';     //only apply if you use trial and redirect to your upgrade page
					...
					var MC_dropdown = 0;                                              //DVD number per row
